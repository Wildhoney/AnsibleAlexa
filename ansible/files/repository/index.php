...
/**
 * Ticket: https://alexandalexa.plan.io/issues/370
 * Code to check the website URL and redirect to the correct magento
 * website or store
 */
if (in_array($_SERVER['HTTP_HOST'], $usWebsiteDomains)) {
	$mageRunType = 'website';
	$mageRunCode = 'website_usa';
}else if (in_array($_SERVER['HTTP_HOST'], $euWebsiteDomains)) {
	$mageRunType = 'website';
	$mageRunCode = 'website_eu';
} else if (in_array($_SERVER['HTTP_HOST'], $worldWebsiteDomains)) {
	$mageRunType = 'website';
	$mageRunCode = 'website_int';
} else if (in_array($_SERVER['HTTP_HOST'], $saWebsiteDomains)) {
    $mageRunType = 'website';
    $mageRunCode = 'website_sa';
}
...
if ($_slowRequestTime) Varien_Profiler::enable(); // PROFILER
